...
import { LeadEndpointRequest } from '../model/leadEndpointRequest';
import { LeadResponse } from '../model/leadResponse';
import { MetaResponse } from '../model/metaResponse';
import { PaginatedLeadList } from '../model/paginatedLeadList';
...
export class LeadsApi {
     ...
     */
    public async leadsCreate (leadEndpointRequest: LeadEndpointRequest, isDebugMode?: boolean, runAsync?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeadResponse;  }> {
        ...
        // verify required parameter 'leadEndpointRequest' is not null or undefined
        if (leadEndpointRequest === null || leadEndpointRequest === undefined) {
            throw new Error('Required parameter leadEndpointRequest was null or undefined when calling leadsCreate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(leadEndpointRequest, "LeadEndpointRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: LeadResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "LeadResponse");
     ...
     * @param convertedAccountId If provided, will only return leads with this account.
     * @param convertedContactId If provided, will only return leads with this contact.
    ...
    public async leadsList (convertedAccountId?: string, convertedContactId?: string, createdAfter?: Date, createdBefore?: Date, cursor?: string, includeDeletedData?: boolean, includeRemoteData?: boolean, modifiedAfter?: Date, modifiedBefore?: Date, ownerId?: string, pageSize?: number, remoteId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaginatedLeadList;  }> {
        ...
        if (convertedAccountId !== undefined) {
            localVarQueryParameters['converted_account_id'] = ObjectSerializer.serialize(convertedAccountId, "string");
        }

        if (convertedContactId !== undefined) {
            localVarQueryParameters['converted_contact_id'] = ObjectSerializer.serialize(convertedContactId, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PaginatedLeadList;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PaginatedLeadList");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async leadsMetaPostRetrieve (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetaResponse;  }> {
        const localVarPath = this.basePath + '/leads/meta/post';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param includeRemoteData Whether to include the original data Merge fetched from the third-party to produce these models.
     */
    public async leadsRetrieve (id: string, includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Lead;  }> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling leadsRetrieve.');
        }
