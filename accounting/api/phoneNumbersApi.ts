...
import { AccountingPhoneNumber } from '../model/accountingPhoneNumber';
...
export class PhoneNumbersApi {
     ...
     */
    public async phoneNumbersRetrieve (id: string, includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountingPhoneNumber;  }> {
        const localVarPath = this.basePath + '/phone-numbers/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling phoneNumbersRetrieve.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AccountingPhoneNumber;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AccountingPhoneNumber");
