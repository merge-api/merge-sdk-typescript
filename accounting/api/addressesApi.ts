...
export class AddressesApi {
     ...
     */
    public async addressesRetrieve (id: string, includeRemoteData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Address;  }> {
        const localVarPath = this.basePath + '/addresses/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling addressesRetrieve.');
        }
