...
export class AttachmentsApi {
     ...
     */
    public async attachmentsCreate (attachmentEndpointRequest: AttachmentEndpointRequest, isDebugMode?: boolean, runAsync?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AttachmentResponse;  }> {
