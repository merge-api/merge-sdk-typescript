...
export class TagsApi extends runtime.BaseAPI {
     ...
     */
    async tagsRetrieveRaw(requestParameters: TagsRetrieveRequest): Promise<runtime.ApiResponse<Tag | undefined>> {
        if (requestParameters.xAccountToken === null || requestParameters.xAccountToken === undefined) {
        ...
        const response = await this.request({
            path: `/ticketing/v1/tags/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Returns a `Tag` object with the given `id`.
     */
    async tagsRetrieve(requestParameters: TagsRetrieveRequest): Promise<Tag | undefined> {
