...
export class CommentsApi extends runtime.BaseAPI {
     ...
     */
    async commentsListRaw(requestParameters: CommentsListRequest): Promise<runtime.ApiResponse<PaginatedCommentList>> {
        if (requestParameters.xAccountToken === null || requestParameters.xAccountToken === undefined) {
     ...
     * Returns a list of `Comment` objects.
     */
    async commentsList(requestParameters: CommentsListRequest): Promise<PaginatedCommentList> {
