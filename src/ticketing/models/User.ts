...
export function UserFromJSON(json: JSONValue): User {
    return UserFromJSONTyped(json);
}

export function UserFromJSONTyped(json: JSONValue): User {
...
export function UserToJSON(value?: User | null): JSONValue {
