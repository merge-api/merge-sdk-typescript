 ...
 * 
 * @export
 * @interface MKTGTemplateResponse
 */
export interface MKTGTemplateResponse {
    /**
     * 
     * @type {Template}
     * @memberof MKTGTemplateResponse
     */
    model: Template;
    /**
     * 
...
export function MKTGTemplateResponseFromJSON(json: JSONValue): MKTGTemplateResponse | undefined {
    return MKTGTemplateResponseFromJSONTyped(json);
}

export function MKTGTemplateResponseFromJSONTyped(json: JSONValue): MKTGTemplateResponse | undefined {
    ...
    return {
        ...
        'model': TemplateFromJSON(json['model']) as Template,
...
export function MKTGTemplateResponseToJSON(value?: MKTGTemplateResponse): JSONValue {
    ...
    return {
        ...
        'model': TemplateToJSON(value.model),
