...
export class JobsApi extends runtime.BaseAPI {
     ...
     */
    async jobsListRaw(requestParameters: JobsListRequest): Promise<runtime.ApiResponse<PaginatedJobList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedJobListFromJSON(jsonValue));
    }

    /**
     * Returns a list of `Job` objects.
     */
    async jobsList(requestParameters: JobsListRequest): Promise<PaginatedJobList> {
