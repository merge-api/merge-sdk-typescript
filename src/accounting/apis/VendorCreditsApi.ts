...
import {
    ...
    PaginatedVendorCreditListFromJSON,
    PaginatedVendorCreditListToJSON,
    VendorCredit,
...
export class VendorCreditsApi extends runtime.BaseAPI {
     ...
     */
    async vendorCreditsListRaw(requestParameters: VendorCreditsListRequest): Promise<runtime.ApiResponse<PaginatedVendorCreditList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedVendorCreditListFromJSON(jsonValue));
    }

    /**
     * Returns a list of `VendorCredit` objects.
     */
    async vendorCreditsList(requestParameters: VendorCreditsListRequest): Promise<PaginatedVendorCreditList> {
