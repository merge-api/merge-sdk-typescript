...
import {
    ...
    PaginatedCreditNoteListFromJSON,
    PaginatedCreditNoteListToJSON,
} from '../models';
...
export class CreditNotesApi extends runtime.BaseAPI {
     ...
     */
    async creditNotesListRaw(requestParameters: CreditNotesListRequest): Promise<runtime.ApiResponse<PaginatedCreditNoteList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedCreditNoteListFromJSON(jsonValue));
    }

    /**
     * Returns a list of `CreditNote` objects.
     */
    async creditNotesList(requestParameters: CreditNotesListRequest): Promise<PaginatedCreditNoteList> {
