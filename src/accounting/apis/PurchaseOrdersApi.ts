...
import {
    ...
    PaginatedPurchaseOrderListFromJSON,
    PaginatedPurchaseOrderListToJSON,
    PurchaseOrder,
...
export class PurchaseOrdersApi extends runtime.BaseAPI {
     ...
     */
    async purchaseOrdersListRaw(requestParameters: PurchaseOrdersListRequest): Promise<runtime.ApiResponse<PaginatedPurchaseOrderList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedPurchaseOrderListFromJSON(jsonValue));
    }

    /**
     * Returns a list of `PurchaseOrder` objects.
     */
    async purchaseOrdersList(requestParameters: PurchaseOrdersListRequest): Promise<PaginatedPurchaseOrderList> {
