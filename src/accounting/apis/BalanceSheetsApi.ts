...
import {
    ...
    PaginatedBalanceSheetListFromJSON,
    PaginatedBalanceSheetListToJSON,
} from '../models';
...
export class BalanceSheetsApi extends runtime.BaseAPI {
     ...
     */
    async balanceSheetsListRaw(requestParameters: BalanceSheetsListRequest): Promise<runtime.ApiResponse<PaginatedBalanceSheetList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedBalanceSheetListFromJSON(jsonValue));
    }

    /**
     * Returns a list of `BalanceSheet` objects.
     */
    async balanceSheetsList(requestParameters: BalanceSheetsListRequest): Promise<PaginatedBalanceSheetList> {
    ...
    async balanceSheetsRetrieveRaw(requestParameters: BalanceSheetsRetrieveRequest): Promise<runtime.ApiResponse<BalanceSheet>> {
        ...
        const response = await this.request({
            path: `/balance-sheets/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
