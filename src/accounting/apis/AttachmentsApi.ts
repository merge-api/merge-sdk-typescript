...
import {
    ...
    PaginatedAccountingAttachmentListFromJSON,
    PaginatedAccountingAttachmentListToJSON,
} from '../models';
...
export class AttachmentsApi extends runtime.BaseAPI {
     ...
     */
    async attachmentsListRaw(requestParameters: AttachmentsListRequest): Promise<runtime.ApiResponse<PaginatedAccountingAttachmentList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedAccountingAttachmentListFromJSON(jsonValue));
    }

    /**
     * Returns a list of `AccountingAttachment` objects.
     */
    async attachmentsList(requestParameters: AttachmentsListRequest): Promise<PaginatedAccountingAttachmentList> {
     ...
     */
    async attachmentsRetrieveRaw(requestParameters: AttachmentsRetrieveRequest): Promise<runtime.ApiResponse<AccountingAttachment>> {
        if (requestParameters.xAccountToken === null || requestParameters.xAccountToken === undefined) {
     ...
     * Returns an `AccountingAttachment` object with the given `id`.
     */
    async attachmentsRetrieve(requestParameters: AttachmentsRetrieveRequest): Promise<AccountingAttachment> {
