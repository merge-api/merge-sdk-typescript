...
export class ExpensesApi extends runtime.BaseAPI {
     ...
     */
    async expensesListRaw(requestParameters: ExpensesListRequest): Promise<runtime.ApiResponse<PaginatedExpenseList>> {
     ...
     * Returns a list of `Expense` objects.
     */
    async expensesList(requestParameters: ExpensesListRequest): Promise<PaginatedExpenseList> {
